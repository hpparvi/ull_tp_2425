PROGRAM input_data
  ...
  DO i = 1, n
     ...
     WRITE(12, "(I3, 7X, 7(ES12.4))") i, p(i)%m, rx, ry, rz, 0.0, 0.0, 0.0 !Write the mass and the current position and velocity of each particle to the input file
  END DO
